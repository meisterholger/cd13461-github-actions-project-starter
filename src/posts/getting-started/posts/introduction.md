...
You can read the Eleventy documentation [on 11ty.dev](https://www.11ty.dev/).
...
You can read the Markdown Guide [on markdownguide.org](https://www.markdownguide.org/).
